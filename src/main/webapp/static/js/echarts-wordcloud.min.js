	...
	return function(t) {
		...
		function m(t, e, r, n) {
			...
			if(r && (s += r[0] + r[2]), t && n) {
				...
				if(null != l && s > l) t = "", a = [];
					...
					for(var u = f(h - (r ? r[1] + r[3] : 0), e, n.ellipsis, {
							minChar: n.minChar,
		...
		function x(t, e) {
			...
			for(var m = 0; m < s.length; m++) {
				for(var x = s[m], w = 0, _ = 0, S = 0; S < x.tokens.length; S++) {
					...
					var D = T.textWidth,
						L = null == D || "auto" === D;
					if("string" == typeof D && "%" === D.charAt(D.length - 1)) M.percentWidth = D, u.push(M), D = 0;
					else {
						if(L) {
							D = M.textWidth;
		...
		function v(t, e, r) {
			...
			if(r) {
				...
				if(s instanceof Array) n = r.x + x(s[0], r.width), i = r.y + x(s[1], r.height);
				else {
		...
		function o(t, e, r, n, i) {
			...
			if(o || s) {
				var h;
				if("raw" === l) h = "group" === t.type ? new f(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
		...
		function g(t) {
			if(!t.__isHover) {
				if(v(t), t.useHoverLayer) t.__zr && t.__zr.addHover(t, t.__hoverStl);
				else {
					var e = t.style,
			...
			_animateToShallow: function(t, e, r, n, i) {
				...
				for(var s in r)
					if(r.hasOwnProperty(s))
						if(null != e[s]) l(r[s]) && !h(r[s]) ? this._animateToShallow(t ? t + "." + s : s, e[s], r[s], n, i) : (a[s] = r[s], o++);
						else if(null != r[s])
					if(t) {
						var u = {};
			...
			if(_) {
				...
				if(f || !O) {
					...
					var Y = function(t, e) {
							...
							if(0 !== n)
								if(z = (e - P[r]) / n, w)
									if(E = I[r], N = I[0 === r ? r : r - 1], W = I[r > _ - 2 ? _ - 1 : r + 1], q = I[r > _ - 3 ? _ - 1 : r + 2], M) u(N, E, W, q, z, z * z, z * z * z, g(t, i), C);
									else {
										var l;
										if(T) l = u(N, E, W, q, z, z * z, z * z * z, X, 1), l = d(X);
										else {
											if(k) return o(E, W, z);
				...
				var a = function() {
					...
					l = function(t, e) {
						...
						if(a) {
							...
							var h, u, c, f, d, v, g, p = n.gridSize,
								m = p - n.maskGapWidth,
								...
								F = function(e, r, i, a, o, s, l, h, u) {
									...
									v[3], v[0], v[1], v[3], v[2], v[0], t.forEach(function(t) {
										if(t.getContext) {
											...
											if(u)
												for(var x in u) l.setAttribute(x, u[x]);
							...
							! function() {
								var e = t[0];
								if(e.getContext) u = Math.ceil(e.width / p), c = Math.ceil(e.height / p);
								else {
