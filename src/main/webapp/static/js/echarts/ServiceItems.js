...
function draw() {
    $.ajax({
        ...
        success: function (data) {
            ...
            var leftbottomname = [];
            var leftbottomvalue = [];
            var map = eval(data.annualgrowth);
            for (var i = 0; i < map.length; i++) {

                leftbottomname[i] = data.annualgrowth[i].areas;
                leftbottomvalue[i] = data.annualgrowth[i].number;
            }
            option = {
                color: ['#3398DB'],
                tooltip: {
            ...
            /** 把查询到的值放到对应位置 */
            var leftbottom1name = [];
            var leftbottom1value = [];
            var map = eval(data.monthlygrowth);
            for (var i = 0; i < map.length; i++) {

                leftbottom1name[i] = data.monthlygrowth[i].areas;
                leftbottom1value[i] = data.monthlygrowth[i].number;
            }
            option = {
                color: ['#3398DB'],
                tooltip: {
            ...
            for (var i = 0; i < map.length; i++) {
                ...
                lefttopsum.name = data.serviceType[i].areas;
                lefttopsum.value = data.serviceType[i].number;
                lefttop[i] = lefttopsum;
                lefttoplenged[i] = data.serviceType[i].areas;
            }
            ...
            for (var i = 0; i < map.length; i++) {
                var lefttop1sum = new Object();
                lefttop1sum.name = data.serviceArea[i].areas;
                lefttop1sum.value = data.serviceArea[i].number;
                lefttop1[i] = lefttop1sum;
                lefttop1lenged[i] = data.serviceArea[i].areas;
            }
            /*option = {
                color : [ '#21539c', '#3398db', '#7fc0fd', '#6ed5d6',
                        '#04a29d', '#cfa960', '#f1d85d', '#21539c',
            ...
            myChart3 = echarts
                .init(document.getElementById('lefttop1'));
            ...
            document.getElementById('toptext').innerText = data.agencyhasshown;
