...
<div id="pdf">
    ...
    <div onclick="location.href='${proPath}/system/ValidOrder'"
         style="position: absolute;top: 12%;z-index: 200;left: 37%;width: 30%;height:10%;cursor:pointer">
        <img src="${proPath}/static/img/home/orange.png" style="width: 43%;height: 100%;">
        <span id="youxiaodingdan"
              style="position: absolute;top: 28%;z-index: 200;left: 16.5%;color: #FFB026;font-size: 24px;font-weight: bolder"></span>
        <span style="position: absolute;top: 60%;z-index: 200;left: 15%;color: #FFB026">有效订单数</span>

        <img src="${proPath}/static/img/home/purple.png"
             style="width: 43%;height: 100%;margin-left: 10%;cursor:pointer">
        <span id="jine"
              style="position: absolute;top: 28%;z-index: 200;left: 68%;color: #D800FF;font-size: 24px;font-weight: bolder"></span>
    ...
    <!--左上角背景-->
    <img src="${proPath}/static/img/home/lefttop.png"
         style="position: absolute;top: 9%;left: 2%;z-index: 180;width: 24.5%;">

    <!--服务机构数量   -->
    <!--a标签用于在用户点击服务机构数量文字 以及文字旁的浅蓝色圈跳转到 服务机构数的二级界面  -->
    <a href="${proPath}/system/jumptoServiceOrganization">
        <!-- 服务机构数的浅蓝色圈 -->
        <img src="${proPath}/static/img/home/blue.png"
             style="z-index: 200; position: absolute; top: 10.5%;left: 3%;cursor:pointer"
             class="boder"/>
        <!-- 服务机构数的文字 -->
    </a>
    <!--服务项目数量   -->
    ...
    <table style="width:27.5%;height: 8%;z-index:150;position: absolute;top:12%;text-align: center;left:3.5%;">
        <tr>
            <!-- 服务机构数的数字-->
            <td style="width: 25%;margin-left: 1rem"><a id="fuwujigou"
                                                        href="${proPath}/system/jumptoServiceOrganization"
                                                        class="value"
                                                        style="color: #06AAFF;font-size: 2rem;margin-left: -1rem;margin-top: -1rem"></a>
            </td>
            <td style="width: 12.5%;"></td>
            <!-- 服务项目数的数字 -->
            <td style="width: 8%; "><a id="fuwuxiangmu" href="${proPath}/system/jumptoServiceItems" class="value"
                                       style="color: #0DDE79;font-size: 2rem;margin-left: -1.3rem;margin-top: -1rem"></a>
            </td>
            <td style="width: 7%;font-size: 2rem"></td>
            <!--大型仪器数的数字  -->
            <td><a id="daxingyiqi" href="${proPath}/system/LargeInstrument" class="value"
                   style="color:#A219FA;font-size: 2rem;left: -4%;margin-left: -1.7rem;margin-top: -1rem"></a>
            </td>
    ...
    <table style="width:27.5%;height: 9%;z-index:150;position: absolute;top:27%;text-align: center;left:3.5%;">
        <tr>
            ...
            <td style="width: 25%;margin-left: 1rem">
                <a id="kejichengguo" href="${proPath}/system/Technology" class="value"
                   style="color:#F1D90B;font-size: 2rem;margin-left: -0.5rem"></a>
            </td>
            <td style="width: 12.5%;"></td>
            <!--专家人才数量数字   -->
            <td style="width: 8%; ">
                <a id="zhuanjiarencai" href="${proPath }/system/ExpertTalent" class="value"
                   style="color: #D800FF;font-size: 2rem;margin-left: -0.5rem"></a>
            </td>
            <td style="width: 7%;font-size: 2rem"></td>
            <!--政策发布数量数字   -->
            <td>
                <a id="zhengcefabu" href="${proPath}/system/PolicyNum" class="value"
                   style="color: #0DDE79;font-size: 2rem;margin-left: -1.7rem;"></a>
            </td>
            <td style="width: 10%;font-size: 2rem"></td>
        </tr>
    ...
    <table style="position: absolute;top: 42%;left: 1.2%;z-index: 200;width: 25%;height: 25%;text-align: center;">
        <tr style="height: 45%;">
            <td style="width: 45%;color: #00D0FE;top: 1%;cursor:pointer"
                onclick="location.href='${proPath}/system/RegisteredBusiness'">
                <span id="zhuceqiye" style="font-size: 1.5rem;"></span>
                <br>
                注册企业数量
            </td>
            <td style="width: 15%"></td>
            <td style="width: 45%;color: #FFB026;cursor:pointer"
                onclick="location.href='${proPath}/system/TechnologyNeeds'">
    ...
    <div id="bar1" onclick="location.href='${proPath}/system/Resources'"
         style="width:25%;height: 30%;position: absolute;top:12%;right:0.1%;"></div>
