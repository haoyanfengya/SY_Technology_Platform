...
<head>
    ...
    <!--这个页面图表制作的js -->
    <script type="text/javascript" src="${proPath}/static/js/echarts/ServiceItems.js"></script>
</head>
<style>
    html, body, #pdf {
        width: 100%;
...
<body>
<a href="javascript:downpdf('服务项目发布情况')">
    <img src="${proPath}/static/img/public/exp.png" style="position: absolute;top:6.2%;right:4.5%;z-index:700;"
         title="点击导出pdf">
</a>
...
<div id="pdf">
    <img src="${proPath}/static/img/ServiceItems/allback.png" style="width: 100%;height: 100%;z-index:50;"/>
    <img src="${proPath}/static/img/ServiceItems/background.png"
    ...
    <table style="width:100%;height: 9%; z-index:150;position: absolute;top:0%;">
        <tr>
            <td style="font-size: 2rem;">服务项目发布情况</td>
        </tr>
    </table>
    <table style="width: 100%;z-index:150;position: absolute; top:13.5%;height:6%;">
        <tr>
            <td style="width:2.5%;"></td>
            <td style="width:46.5%;" class="reportname">服务类型分布图</td>
            <td style="width:1%;"></td>
            <td style="width:46.6%;" class="reportname">服务领域分布图</td>
            <td></td>

        </tr>
    </table>
    <div style="width:46.5%;height:35%;left:2.5%;z-index: 150;position: absolute;top:18.4%;" id="lefttop"></div>
    <div style="width:46.5%;height:35%;z-index: 150;left:50%;position: absolute;top:18.4%;" id="lefttop1"></div>

    <table style="width: 100%;z-index:150;position: absolute; top:56%;height:6%;">
        <tr>
            <td style="width:2.5%;"></td>
            <td style="width:46.5%;" class="reportname">服务项目年增长情况</td>
            <td style="width:1%;"></td>
            <td style="width:46.6%;" class="reportname">服务项目月增长情况</td>
            <td></td>

        </tr>
    </table>
    <div style="width:46.5%;height:36%;left:2.5%;z-index: 150;position: absolute;top:60.5%;" id="leftbottom"></div>
    <div style="width:46.5%;height:36%;left:50%;z-index:150;position: absolute;top:60.5%;" id="leftbottom1"></div>
</div>
</body>
