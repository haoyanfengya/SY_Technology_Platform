...
<div id="pdf">
    ...
    <!-- tubiao -->
    <table
            style="width: 62.5%; height: 4.5%; position: absolute; top: 12%; left: 31.8%; z-index: 200;"
            class="reportname">
        <tr>
    ...
    <div style="width: 62.5%;height: 36.4%;position: absolute; top:17.5%;left:31.8%;z-index: 200;"
         id="niandingdan&jine"></div>


    <table
            style="width: 62.5%; height: 4.5%; position: absolute; top: 55%; left: 31.8%; z-index: 200;"
            class="reportname">
        <tr>
    ...
    <div style="width: 62.5%;height: 36.4%;position: absolute; top:60%;left:31.8%;z-index: 200;"
         id="yuedingdan&jine"></div>
</div>
</body>
